 ...
 *
 */
public class CountCommunities extends Configured implements Tool {
...
//				Text userGroup = new Text(userGroupString);
				context.write(value, new LongWritable((long)1));
//			}
		}
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new CountCommunities(), args);
		System.exit(result);
	}
